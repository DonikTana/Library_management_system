...
ALTER TABLE books
ADD COLUMN IF NOT EXISTS publisher VARCHAR(255) DEFAULT NULL AFTER isbn,
ADD COLUMN IF NOT EXISTS total_quantity INT NOT NULL DEFAULT 1 AFTER available,
ADD COLUMN IF NOT EXISTS available_quantity INT NOT NULL DEFAULT 1 AFTER total_quantity;
